...
func (mr *MockServiceInterfaceMockRecorder) CreateRole(ctx, role interface{}) *gomock.Call {
...
func (mr *MockServiceInterfaceMockRecorder) GetAll(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
