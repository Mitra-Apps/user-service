...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/Mitra-Apps/be-user-service/gen/domain/user/proto/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	UserServiceName = "domain.user.proto.v1.UserService"
)
...
const (
	...
	UserServiceGetUsersProcedure = "/domain.user.proto.v1.UserService/GetUsers"
)

// UserServiceClient is a client for the domain.user.proto.v1.UserService service.
type UserServiceClient interface {
	GetUsers(context.Context, *connect.Request[v1.GetUsersRequest]) (*connect.Response[v1.GetUsersResponse], error)
}

// NewUserServiceClient constructs a client for the domain.user.proto.v1.UserService service. By
...
// GetUsers calls domain.user.proto.v1.UserService.GetUsers.
...
// UserServiceHandler is an implementation of the domain.user.proto.v1.UserService service.
...
func NewUserServiceHandler(svc UserServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/domain.user.proto.v1.UserService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedUserServiceHandler) GetUsers(context.Context, *connect.Request[v1.GetUsersRequest]) (*connect.Response[v1.GetUsersResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("domain.user.proto.v1.UserService.GetUsers is not implemented"))
}
