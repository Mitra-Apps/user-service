...
import (
	...
	context "context"
	errors "errors"
	proto "github.com/Mitra-Apps/be-user-service/domain/user/proto"
	http "net/http"
	strings "strings"
)
...
type UserServiceClient interface {
	GetUsers(context.Context, *connect.Request[proto.GetUsersRequest]) (*connect.Response[proto.GetUsersResponse], error)
}
...
func NewUserServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UserServiceClient {
	...
	return &userServiceClient{
		getUsers: connect.NewClient[proto.GetUsersRequest, proto.GetUsersResponse](
			httpClient,
...
type userServiceClient struct {
	getUsers *connect.Client[proto.GetUsersRequest, proto.GetUsersResponse]
}

// GetUsers calls proto.UserService.GetUsers.
func (c *userServiceClient) GetUsers(ctx context.Context, req *connect.Request[proto.GetUsersRequest]) (*connect.Response[proto.GetUsersResponse], error) {
...
func (UnimplementedUserServiceHandler) GetUsers(context.Context, *connect.Request[proto.GetUsersRequest]) (*connect.Response[proto.GetUsersResponse], error) {
