...
func (m *MockRole) GetRoleByUserId(ctx context.Context, userID uuid.UUID) ([]*entity.Role, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRoleMockRecorder) GetRoleByUserId(ctx, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetRoleByUserId", reflect.TypeOf((*MockRole)(nil).GetRoleByUserId), ctx, userID)
}
